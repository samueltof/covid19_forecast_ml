...
ax.plot(data_plot['date_time'],data_plot['num_cases_7dRA'], color='k', label='Observed')
ax.plot(predict_data['date_time'],predict_data['forecast_cases'], color='darkorange', label='Predicted')
